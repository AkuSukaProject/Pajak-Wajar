...
- Penanda isian yang belum lengkap: menekan Lanjutkan dengan isian wajib yang kosong kini menggulir ke kolomnya, memfokuskannya, menggetarkannya sebentar (`motion-shake`, diredam oleh `prefers-reduced-motion`), dan menandainya merah dengan pesan yang menyebut cara memperbaikinya. Yang diwajibkan hanya pekerjaan utama, uang masuk tahun berjalan, dan penghasilan neto gaji ketika pengguna menandai diri sebagai pegawai tetap. Kolom rupiah lain tetap boleh bernilai nol karena nol memang jawaban yang sah di sana.
- Perhitungan keluarga: sebelumnya setiap pengguna yang punya pasangan tidak mendapat nominal, bahkan ketika pasangannya tidak berpenghasilan. `tests/keluarga.test.ts` (18 tes) memastikan pelaporan gabung dengan pasangan tanpa penghasilan menghasilkan nominal yang sama persis dengan profil tanpa penggabungan ber-PTKP setara, sesuai UU PPh Pasal 8 ayat (1), sementara pasangan berpenghasilan, jawaban belum yakin, jawaban kosong, pisah harta, pisah kewajiban, dan status yang belum dipastikan tetap ditahan dengan alasan spesifik masing-masing. Satu tes menyapu seluruh matriks status pelaporan × jawaban penghasilan pasangan agar tidak ada cabang yang berhenti tanpa alasan. Kasus dokter multi-sumber yang diajukan pegawai DJP ikut dikunci sebagai profil demo dan tes regresi.
